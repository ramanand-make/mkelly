$(function() {
    ...
    var myChart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                borderWidth: "3",
                lineTension:0.3,
                backgroundColor: "rgba(5, 75, 44, .1)",
                fill: true,
    ...
    var datapie = {
        ...
        datasets: [{
            data: [20, 20, 30, 5, 25],
            backgroundColor: ['#054B2C', '#05c3fb', '#09ad95', '#1170e4', '#e82646']
        }]
    };
    var optionpie = {
        maintainAspectRatio: false,
    ...
    var myChart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                borderColor: "rgba(5, 75, 44, .8)",
                borderWidth: "1",
                backgroundColor: "rgba(5, 75, 44, .4)"
            }, {
                label: "Data2",
    ...
    var myChart = new Chart(ctx, {
        ...
        data: {
            datasets: [{
                data: [18, 15, 9, 6, 19],
                backgroundColor: ['#054B2C', '#05c3fb', '#09ad95', '#1170e4', '#e82646'],
                hoverBackgroundColor: ['#054B2C', '#05c3fb', '#09ad95', '#1170e4', '#e82646'],
